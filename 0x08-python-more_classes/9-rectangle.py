...
class Rectangle:
    ...
    @property
    def width(self):
        """Function Gets the width of the Rectangle."""
        return self.__width
    ...
    @property
    def height(self):
        """Function gets the height of the Rectangle."""
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Code return the Rectangle with the greater area.
        Args:
    ...
    def __del__(self):
        """Function Print a message for every deletion of a Rectangle."""
        type(self).number_of_instances -= 1
        print("Bye rectangle...")
