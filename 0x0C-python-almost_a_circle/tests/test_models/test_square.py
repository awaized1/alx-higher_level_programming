#!/usr/bin/python3
'''Code Module for the Square unit tests.'''
import unittest
...
class TestSquare(unittest.TestCase):
    '''Test fors the Base class.'''

    def setUp(self):
        '''Function imports module, instantiates class'''
        Base._Base__nb_objects = 0

    def tearDown(self):
        '''Function cleans up after each test_method.'''
        pass


    def test_A_class(self):
        '''Function tests Square class type.'''
        self.assertEqual(str(Square),
                         "<class 'models.square.Square'>")

    def test_B_inheritance(self):
        '''Function tests if a Square inherits Base.'''
        self.assertTrue(issubclass(Square, Base))

    def test_C_constructor_no_args(self):
        '''Function tests constructor signature.'''
    ...
    def test_C_constructor_many_args(self):
        '''The function tests constructor signature.'''
        with self.assertRaises(TypeError) as e:
            r = Square(1, 2, 3, 4, 5)
...
were given"
    ...
    def test_D_instantiation_positional(self):
        '''This tests positional instantiation.'''
        r = Square(5, 10, 15)
    ...
    def test_D_instantiation_keyword(self):
        '''Code then Tests positional instantiation.'''
    ...
    def test_E_id_inherited(self):
        '''Code tests if id is inherited from Base.'''
        Base._Base__nb_objects = 98
        r = Square(2)
        self.assertEqual(r.id, 99)

    def test_F_properties(self):
        '''Code tests the property getters/setters.'''
        r = Square(5, 9)
        r.size = 98
        r.x = 102
        r.y = 103
    ...
    def invalid_types(self):
        '''Function returns tuple of types for validation.'''
        a = (3.14, -1.1, float('inf'), float('-inf'), True, "str", (2,),
             [4], {5}, {6: 7}, None)
        return a

    def test_G_validate_type(self):
        '''Function tests the property validation.'''
        r = Square(1)
        attributes = ["x", "y"]
    ...
    def test_G_validate_value_negative_ge(self):
        '''Code tests the property validation.'''
        r = Square(1, 2)
        attributes = ["x", "y"]
        for attribute in attributes:
    ...
    def test_G_validate_value_zero(self):
        '''Code tests property validation.'''
        r = Square(1, 2)
        attributes = ["size"]
        for attribute in attributes:
            s = "width must be > 0".format(attribute)
    ...
    def test_H_property(self):
        '''Function tests property setting/getting.'''
        r = Square(1, 2)
    ...
    def test_H_property_range_zero(self):
        '''Function tests the property setting/getting.'''
        r = Square(1, 2)
        r.x = 0
        r.y = 0
    ...
    def test_I_area_no_args(self):
        '''Code tests the area() method signature.'''
        r = Square(5)
        with self.assertRaises(TypeError) as e:
            Square.area()
    ...
    def test_I_area(self):
        '''Code tests the area() method compuation.'''
        r = Square(6)
    ...
    def test_J_display_no_args(self):
        '''Function tests display() method signature.'''
        r = Square(9)
        with self.assertRaises(TypeError) as e:
            Square.display()
    ...
    def test_J_display_simple(self):
        '''Function tests display() method output.'''
        r = Square(1)
        f = io.StringIO()
...
"""
    ...
    def test_K_str_no_args(self):
        '''Function Tests __str__() method signature.'''
        r = Square(5, 2)
        with self.assertRaises(TypeError) as e:
            Square.__str__()
    ...
    def test_K_str(self):
        '''Code tests __str__() method return.'''
        r = Square(5)
        s = '[Square] (1) 0/0 - 5'
    ...
    def test_L_update_no_args(self):
        '''Code tests the update() method signature.'''
        r = Square(5, 2)
        with self.assertRaises(TypeError) as e:
            Square.update()
    ...
    def test_L_update_args(self):
        '''Code tests the update() postional args.'''
        r = Square(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_args_bad(self):
        '''Function tests update() positional arg fubars.'''
        r = Square(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_kwargs(self):
        '''Function tests update() keyword args.'''
        r = Square(5, 2)
        d = r.__dict__.copy()
    ...
    def test_M_to_dictionary(self):
        '''Function tests the to_dictionary() signature:'''
        with self.assertRaises(TypeError) as e:
