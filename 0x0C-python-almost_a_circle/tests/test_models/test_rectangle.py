#!/usr/bin/python3
'''Code module for the rectangle unit tests.'''
import unittest
...
class TestRectangle(unittest.TestCase):
    '''A tests for the Base class.'''

    def setUp(self):
        '''Code imports module and instantiates class'''
        Base._Base__nb_objects = 0

    def tearDown(self):
        '''Code cleans up after every test_method.'''
        pass


    def test_A_class(self):
        '''Function tests Rectangle class type.'''
        self.assertEqual(str(Rectangle),
                         "<class 'models.rectangle.Rectangle'>")

    def test_B_inheritance(self):
        '''The function tests if Rectangle inherits Base.'''
        self.assertTrue(issubclass(Rectangle, Base))

    def test_C_constructor_no_args(self):
        '''The tests constructor signature.'''
...
and 'height'"
    ...
    def test_C_constructor_many_args(self):
        '''Code tests constructor signature.'''
        with self.assertRaises(TypeError) as e:
...
given"
    ...
    def test_C_constructor_one_args(self):
        '''Code then tests constructor signature.'''
        with self.assertRaises(TypeError) as e:
            r = Rectangle(1)
    ...
    def test_D_instantiation_positional(self):
        '''Tests for the positional instantiation.'''
    ...
    def test_D_instantiation_keyword(self):
        '''Function tests for positional instantiation.'''
    ...
    def test_E_id_inherited(self):
        '''Function tests if id is inherited from Base.'''
        Base._Base__nb_objects = 98
        a = Rectangle(2, 4)
        self.assertEqual(a.id, 99)

    def test_F_properties(self):
        '''Function tests property getters/setters.'''
        r = Rectangle(5, 9)
        r.width = 100
        r.height = 101
        r.x = 102
    ...
    def test_G_validate_value_negative_ge(self):
        '''Function tests property validation.'''
        r = Rectangle(1, 2)
        attributes = ["x", "y"]
        for attribute in attributes:
            s = "{} must be >= 0".format(attribute)
    ...
    def test_H_property(self):
        '''The tests for property setting/getting.'''
        r = Rectangle(1, 2)
        attributes = ["x", "y", "width", "height"]
        for attribute in attributes:
            n = randrange(10) + 1
    ...
    def test_I_area(self):
        '''The tests area() for method compuation.'''
        r = Rectangle(5, 6)
    ...
    def test_J_display_no_args(self):
        '''The tests display() for method signature.'''
        r = Rectangle(9, 8)
        with self.assertRaises(TypeError) as e:
            Rectangle.display()
...
"""
    ...
    def test_K_str(self):
        '''Tests for the __str__() method return.'''
        r = Rectangle(5, 2)
    ...
    def test_L_update_no_args(self):
        '''Code tests for update() method signature.'''
        r = Rectangle(5, 2)
        with self.assertRaises(TypeError) as e:
            Rectangle.update()
    ...
    def test_L_update_args_bad(self):
        '''Code tests for update() positional arg fubars.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_kwargs(self):
        '''Code tests update() keyword args.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_M_to_dictionary(self):
        '''Code tests to_dictionary() signature:'''
        with self.assertRaises(TypeError) as e:
